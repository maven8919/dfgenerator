...
class DKBaseballPlayerService {
    ...
    private fun transformLineToBaseballPlayer(line: String?): DKBaseballPlayer {
        ...
        return DKBaseballPlayer(fields?.get(0) as String, fields?.get(1) as String, fields?.get(2) as Int,
                fields?.get(3) as String, fields?.get(4) as Double, fields?.get(5) as String)
    }
